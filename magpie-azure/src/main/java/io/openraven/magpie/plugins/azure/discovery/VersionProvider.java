...
import io.openraven.magpie.plugins.azure.discovery.exception.AzureDiscoveryException;
...
public class VersionProvider {
  ...
  public VersionProvider() {
    ...
    try {
      ...
      throw new AzureDiscoveryException("Unable to parse properties from version.properties resource", e);
    }
